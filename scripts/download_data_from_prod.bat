...
c:\python27\python "c:\Program Files (x86)\Google\google_appengine\appcfg.py" download_data --num_threads=5 --batch_size=100 --application=s~skojjt --url=https://skojjt.appspot.com/_ah/remote_api --kind=Badge --filename=Badge_data.sql3
c:\python27\python "c:\Program Files (x86)\Google\google_appengine\appcfg.py" download_data --num_threads=5 --batch_size=100 --application=s~skojjt --url=https://skojjt.appspot.com/_ah/remote_api --kind=BadgeCompleted --filename=BadgeCompleted_data.sql3
c:\python27\python "c:\Program Files (x86)\Google\google_appengine\appcfg.py" download_data --num_threads=5 --batch_size=100 --application=s~skojjt --url=https://skojjt.appspot.com/_ah/remote_api --kind=BadgePartDone --filename=BadgePartDone_data.sql3
c:\python27\python "c:\Program Files (x86)\Google\google_appengine\appcfg.py" download_data --num_threads=5 --batch_size=100 --application=s~skojjt --url=https://skojjt.appspot.com/_ah/remote_api --kind=BadgeTemplate --filename=BadgeTemplate_data.sql3
